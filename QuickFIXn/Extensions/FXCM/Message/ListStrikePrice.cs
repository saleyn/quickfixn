...
namespace QuickFix.FXCM
{
    public class ListStrikePrice : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("m"));
            }

            public ListStrikePrice(
                    QuickFix.FXCM.Fields.ListID aListID,
                    QuickFix.FXCM.Fields.TotNoStrikes aTotNoStrikes
                ) : this()
            {
                this.ListID = aListID;
            ...
            public QuickFix.FXCM.Fields.TotNoStrikes TotNoStrikes
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.TotNoStrikes();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.TotNoStrikes val) 
            { 
                TotNoStrikes = val;
            }
            
            public QuickFix.FXCM.Fields.TotNoStrikes Get(QuickFix.FXCM.Fields.TotNoStrikes val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.TotNoStrikes val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.TotNoStrikes);
            }
            ...
            public QuickFix.FXCM.Fields.NoStrikes NoStrikes
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.NoStrikes();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.NoStrikes val) 
            { 
                NoStrikes = val;
            }
            
            public QuickFix.FXCM.Fields.NoStrikes Get(QuickFix.FXCM.Fields.NoStrikes val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.NoStrikes val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.NoStrikes);
            }
            ...
            public class NoStrikesGroup : Group
            {
                ...
                public NoStrikesGroup() 
                  :base( QuickFix.FXCM.Fields.Tags.NoStrikes, QuickFix.FXCM.Fields.Tags.Symbol, fieldOrder)
                {
                }
