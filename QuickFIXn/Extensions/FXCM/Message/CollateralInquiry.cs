...
namespace QuickFix.FXCM
{
    public class CollateralInquiry : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("BB"));
            }
            ...
            public QuickFix.FXCM.Fields.NoCollInquiryQualifier NoCollInquiryQualifier
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.NoCollInquiryQualifier();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.NoCollInquiryQualifier val) 
            { 
                NoCollInquiryQualifier = val;
            }
            
            public QuickFix.FXCM.Fields.NoCollInquiryQualifier Get(QuickFix.FXCM.Fields.NoCollInquiryQualifier val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.NoCollInquiryQualifier val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.NoCollInquiryQualifier);
            }
            ...
            {
                public static int[] fieldOrder = {QuickFix.FXCM.Fields.Tags.CollInquiryQualifier, 0};
            
                public NoCollInquiryQualifierGroup() 
                  :base( QuickFix.FXCM.Fields.Tags.NoCollInquiryQualifier, QuickFix.FXCM.Fields.Tags.CollInquiryQualifier, fieldOrder)
                {
                }
                ...
                public override Group Clone()
                {
                    ...
                    return clone;
                            ...
                            public QuickFix.FXCM.Fields.CollInquiryQualifier CollInquiryQualifier
                { 
                    get 
                    {
                        var val = new QuickFix.FXCM.Fields.CollInquiryQualifier();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.FXCM.Fields.CollInquiryQualifier val) 
                { 
                    CollInquiryQualifier = val;
                }
                
                public QuickFix.FXCM.Fields.CollInquiryQualifier Get(QuickFix.FXCM.Fields.CollInquiryQualifier val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.FXCM.Fields.CollInquiryQualifier val) 
                { 
                ...
                { 
                    return IsSetField(QuickFix.FXCM.Fields.Tags.CollInquiryQualifier);
                }
