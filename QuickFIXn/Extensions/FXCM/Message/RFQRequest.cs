...
namespace QuickFix.FXCM
{
    public class RFQRequest : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AH"));
            }

            public RFQRequest(
                    QuickFix.FXCM.Fields.RFQReqID aRFQReqID
                ) : this()
            {
