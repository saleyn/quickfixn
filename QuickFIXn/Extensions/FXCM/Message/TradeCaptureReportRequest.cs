...
namespace QuickFix.FXCM
{
    public class TradeCaptureReportRequest : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AD"));
            }
            ...
            public QuickFix.FXCM.Fields.NoDates NoDates
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.NoDates();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.NoDates val) 
            { 
                NoDates = val;
            }
            
            public QuickFix.FXCM.Fields.NoDates Get(QuickFix.FXCM.Fields.NoDates val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.NoDates val) 
            { 
                return IsSetNoDates();
            }
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.NoDates);
            }
            ...
            {
                public static int[] fieldOrder = {QuickFix.FXCM.Fields.Tags.TradeDate, QuickFix.FXCM.Fields.Tags.TransactTime, 0};
            
                public NoDatesGroup() 
                  :base( QuickFix.FXCM.Fields.Tags.NoDates, QuickFix.FXCM.Fields.Tags.TradeDate, fieldOrder)
                {
                }
