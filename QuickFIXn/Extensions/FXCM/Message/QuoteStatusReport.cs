...
namespace QuickFix.FXCM
{
    public class QuoteStatusReport : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AI"));
            }
            ...
            public QuickFix.FXCM.Fields.QuoteStatusReqID QuoteStatusReqID
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.QuoteStatusReqID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.QuoteStatusReqID val) 
            { 
                QuoteStatusReqID = val;
            }
            
            public QuickFix.FXCM.Fields.QuoteStatusReqID Get(QuickFix.FXCM.Fields.QuoteStatusReqID val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.QuoteStatusReqID val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.QuoteStatusReqID);
            }
