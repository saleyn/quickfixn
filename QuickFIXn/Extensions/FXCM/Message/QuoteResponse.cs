...
namespace QuickFix.FXCM
{
    public class QuoteResponse : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AJ"));
            }

            public QuoteResponse(
                    QuickFix.FXCM.Fields.QuoteRespID aQuoteRespID,
                    QuickFix.FXCM.Fields.QuoteRespType aQuoteRespType,
            ...
            public QuickFix.FXCM.Fields.QuoteRespType QuoteRespType
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.QuoteRespType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.QuoteRespType val) 
            { 
                QuoteRespType = val;
            }
            
            public QuickFix.FXCM.Fields.QuoteRespType Get(QuickFix.FXCM.Fields.QuoteRespType val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.QuoteRespType val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.QuoteRespType);
            }
