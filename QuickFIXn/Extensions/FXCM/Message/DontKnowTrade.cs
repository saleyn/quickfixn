...
namespace QuickFix.FXCM
{
    public class DontKnowTrade : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("Q"));
            }

            public DontKnowTrade(
                    QuickFix.FXCM.Fields.OrderID aOrderID,
                    QuickFix.FXCM.Fields.ExecID aExecID,
                    QuickFix.FXCM.Fields.DKReason aDKReason,
            ...
            public QuickFix.FXCM.Fields.DKReason DKReason
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.DKReason();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.DKReason val) 
            { 
                DKReason = val;
            }
            
            public QuickFix.FXCM.Fields.DKReason Get(QuickFix.FXCM.Fields.DKReason val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.DKReason val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.DKReason);
            }
