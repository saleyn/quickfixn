...
namespace QuickFix.FXCM
{
    public class CollateralInquiryAck : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("BG"));
            }

            public CollateralInquiryAck(
                    QuickFix.FXCM.Fields.CollInquiryID aCollInquiryID,
                    QuickFix.FXCM.Fields.CollInquiryStatus aCollInquiryStatus
                ) : this()
            {
            ...
            public QuickFix.FXCM.Fields.CollInquiryStatus CollInquiryStatus
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.CollInquiryStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.CollInquiryStatus val) 
            { 
                CollInquiryStatus = val;
            }
            
            public QuickFix.FXCM.Fields.CollInquiryStatus Get(QuickFix.FXCM.Fields.CollInquiryStatus val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.CollInquiryStatus val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.CollInquiryStatus);
            }
            
            public QuickFix.FXCM.Fields.CollInquiryResult CollInquiryResult
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.CollInquiryResult();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.CollInquiryResult val) 
            { 
                CollInquiryResult = val;
            }
            
            public QuickFix.FXCM.Fields.CollInquiryResult Get(QuickFix.FXCM.Fields.CollInquiryResult val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.CollInquiryResult val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.CollInquiryResult);
            }
