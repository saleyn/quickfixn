...
namespace QuickFix.FXCM
{
    public class QuoteCancel : Message
    {
            ...
            public QuoteCancel(
                    ...
                    QuickFix.FXCM.Fields.QuoteCancelType aQuoteCancelType
                ) : this()
            {
            ...
            public QuickFix.FXCM.Fields.QuoteCancelType QuoteCancelType
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.QuoteCancelType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.QuoteCancelType val) 
            { 
                QuoteCancelType = val;
            }
            
            public QuickFix.FXCM.Fields.QuoteCancelType Get(QuickFix.FXCM.Fields.QuoteCancelType val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.QuoteCancelType val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.QuoteCancelType);
            }
