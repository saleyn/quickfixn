...
namespace QuickFix.FXCM
{
    public class DerivativeSecurityList : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AA"));
            }
