...
namespace QuickFix.FXCM
{
    public class Advertisement : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("7"));
            }

            public Advertisement(
                    QuickFix.FXCM.Fields.AdvId aAdvId,
                    QuickFix.FXCM.Fields.AdvTransType aAdvTransType,
                    QuickFix.FXCM.Fields.Symbol aSymbol,
                    QuickFix.FXCM.Fields.AdvSide aAdvSide,
            ...
            public QuickFix.FXCM.Fields.AdvId AdvId
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.AdvId();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.AdvId val) 
            { 
                AdvId = val;
            }
            
            public QuickFix.FXCM.Fields.AdvId Get(QuickFix.FXCM.Fields.AdvId val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.AdvId val) 
            { 
                return IsSetAdvId();
            }
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.AdvId);
            }
            
            public QuickFix.FXCM.Fields.AdvTransType AdvTransType
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.AdvTransType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.AdvTransType val) 
            { 
                AdvTransType = val;
            }
            
            public QuickFix.FXCM.Fields.AdvTransType Get(QuickFix.FXCM.Fields.AdvTransType val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.AdvTransType val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.AdvTransType);
            }
            
            public QuickFix.FXCM.Fields.AdvRefID AdvRefID
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.AdvRefID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.AdvRefID val) 
            { 
                AdvRefID = val;
            }
            
            public QuickFix.FXCM.Fields.AdvRefID Get(QuickFix.FXCM.Fields.AdvRefID val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.AdvRefID val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.AdvRefID);
            }
            ...
            public QuickFix.FXCM.Fields.AdvSide AdvSide
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.AdvSide();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.AdvSide val) 
            { 
                AdvSide = val;
            }
            
            public QuickFix.FXCM.Fields.AdvSide Get(QuickFix.FXCM.Fields.AdvSide val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.AdvSide val) 
            { 
                return IsSetAdvSide();
            }
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.AdvSide);
            }
