...
namespace QuickFix.FIX43
{
    public class BidRequest : Message
    {
            ...
            public void Set(QuickFix.Fields.TradeType val) 
            { 
                TradeType = val;
            }
            ...
            public bool IsSet(QuickFix.Fields.TradeType val) 
            { 
                return IsSetTradeType();
            }
            
            public bool IsSetTradeType() 
            { 
                return IsSetField(QuickFix.Fields.Tags.TradeType);
            }
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.ListID, QuickFix.Fields.Tags.Side, QuickFix.Fields.Tags.TradingSessionID, QuickFix.Fields.Tags.TradingSessionSubID, QuickFix.Fields.Tags.NetGrossInd, QuickFix.Fields.Tags.SettlmntTyp, QuickFix.Fields.Tags.FutSettDate, QuickFix.Fields.Tags.Account, 0};
