...
namespace QuickFix.FIX43
{
    public class NewOrderMultileg : Message
    {
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.AllocAccount, QuickFix.Fields.Tags.IndividualAllocID, QuickFix.Fields.Tags.AllocQty, 0};
