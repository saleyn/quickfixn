    ...
    public class RegistrationInstructions : Message
    {
            ...
            public class NoRegistDtlsGroup : Group
            {
                ...
                { 
                    get 
                    {
                        var val = new QuickFix.Fields.RegistDetls();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.RegistDetls val) 
                { 
                    RegistDetls = val;
                }
                
                public QuickFix.Fields.RegistDetls Get(QuickFix.Fields.RegistDetls val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.Fields.RegistDetls val) 
                { 
                    return IsSetRegistDetls();
                }
                
                public bool IsSetRegistDetls() 
                { 
                    return IsSetField(QuickFix.Fields.Tags.RegistDetls);
                }
