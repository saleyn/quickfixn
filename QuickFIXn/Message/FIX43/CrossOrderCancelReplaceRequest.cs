...
namespace QuickFix.FIX43
{
    public class CrossOrderCancelReplaceRequest : Message
    {
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.Side, QuickFix.Fields.Tags.OrigClOrdID, QuickFix.Fields.Tags.ClOrdID, QuickFix.Fields.Tags.SecondaryClOrdID, QuickFix.Fields.Tags.ClOrdLinkID, QuickFix.Fields.Tags.OrigOrdModTime, QuickFix.Fields.Tags.NoPartyIDs, QuickFix.Fields.Tags.TradeOriginationDate, QuickFix.Fields.Tags.Account, QuickFix.Fields.Tags.AccountType, QuickFix.Fields.Tags.DayBookingInst, QuickFix.Fields.Tags.BookingUnit, QuickFix.Fields.Tags.PreallocMethod, QuickFix.Fields.Tags.NoAllocs, QuickFix.Fields.Tags.QuantityType, QuickFix.Fields.Tags.OrderQty, QuickFix.Fields.Tags.CashOrderQty, QuickFix.Fields.Tags.OrderPercent, QuickFix.Fields.Tags.RoundingDirection, QuickFix.Fields.Tags.RoundingModulus, QuickFix.Fields.Tags.Commission, QuickFix.Fields.Tags.CommType, QuickFix.Fields.Tags.CommCurrency, QuickFix.Fields.Tags.FundRenewWaiv, QuickFix.Fields.Tags.OrderCapacity, QuickFix.Fields.Tags.OrderRestrictions, QuickFix.Fields.Tags.CustOrderCapacity, QuickFix.Fields.Tags.ForexReq, QuickFix.Fields.Tags.SettlCurrency, QuickFix.Fields.Tags.Text, QuickFix.Fields.Tags.EncodedTextLen, QuickFix.Fields.Tags.EncodedText, QuickFix.Fields.Tags.PositionEffect, QuickFix.Fields.Tags.CoveredOrUncovered, QuickFix.Fields.Tags.CashMargin, QuickFix.Fields.Tags.ClearingFeeIndicator, QuickFix.Fields.Tags.SolicitedFlag, QuickFix.Fields.Tags.SideComplianceID, 0};
