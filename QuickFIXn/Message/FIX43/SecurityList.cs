...
namespace QuickFix.FIX43
{
    public class SecurityList : Message
    {
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.TotalNumSecurities);
            }
