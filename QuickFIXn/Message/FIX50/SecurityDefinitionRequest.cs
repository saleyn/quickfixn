...
namespace QuickFix.FIX50
{
    public class SecurityDefinitionRequest : Message
    {
            ...
            public class SubscriptionRequestTypeGroup : Group
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.LegOptionRatio, QuickFix.Fields.Tags.LegPrice, 0};
            
                public SubscriptionRequestTypeGroup() 
                  :base( QuickFix.Fields.Tags.SubscriptionRequestType, QuickFix.Fields.Tags.LegOptionRatio, fieldOrder)
                {
                }
            
                public override Group Clone()
                {
                    var clone = new SubscriptionRequestTypeGroup();
                    clone.CopyStateFrom(this);
                    return clone;
                }
