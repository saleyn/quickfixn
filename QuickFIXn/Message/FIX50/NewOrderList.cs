...
namespace QuickFix.FIX50
{
    public class NewOrderList : Message
    {
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.AllowableOneSidednessPct);
            }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.AllowableOneSidednessValue);
            }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.AllowableOneSidednessCurr);
            }
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.ClOrdID, QuickFix.Fields.Tags.SecondaryClOrdID, QuickFix.Fields.Tags.ListSeqNo, QuickFix.Fields.Tags.ClOrdLinkID, QuickFix.Fields.Tags.SettlInstMode, QuickFix.Fields.Tags.NoPartyIDs, QuickFix.Fields.Tags.TradeOriginationDate, QuickFix.Fields.Tags.TradeDate, QuickFix.Fields.Tags.Account, QuickFix.Fields.Tags.AcctIDSource, QuickFix.Fields.Tags.AccountType, QuickFix.Fields.Tags.DayBookingInst, QuickFix.Fields.Tags.BookingUnit, QuickFix.Fields.Tags.AllocID, QuickFix.Fields.Tags.PreallocMethod, QuickFix.Fields.Tags.NoAllocs, QuickFix.Fields.Tags.SettlType, QuickFix.Fields.Tags.SettlDate, QuickFix.Fields.Tags.CashMargin, QuickFix.Fields.Tags.ClearingFeeIndicator, QuickFix.Fields.Tags.HandlInst, QuickFix.Fields.Tags.ExecInst, QuickFix.Fields.Tags.MinQty, QuickFix.Fields.Tags.MaxFloor, QuickFix.Fields.Tags.ExDestination, QuickFix.Fields.Tags.NoTradingSessions, QuickFix.Fields.Tags.ProcessCode, QuickFix.Fields.Tags.Symbol, QuickFix.Fields.Tags.SymbolSfx, QuickFix.Fields.Tags.SecurityID, QuickFix.Fields.Tags.SecurityIDSource, QuickFix.Fields.Tags.NoSecurityAltID, QuickFix.Fields.Tags.Product, QuickFix.Fields.Tags.CFICode, QuickFix.Fields.Tags.SecurityType, QuickFix.Fields.Tags.SecuritySubType, QuickFix.Fields.Tags.MaturityMonthYear, QuickFix.Fields.Tags.MaturityDate, QuickFix.Fields.Tags.CouponPaymentDate, QuickFix.Fields.Tags.IssueDate, QuickFix.Fields.Tags.RepoCollateralSecurityType, QuickFix.Fields.Tags.RepurchaseTerm, QuickFix.Fields.Tags.RepurchaseRate, QuickFix.Fields.Tags.Factor, QuickFix.Fields.Tags.CreditRating, QuickFix.Fields.Tags.InstrRegistry, QuickFix.Fields.Tags.CountryOfIssue, QuickFix.Fields.Tags.StateOrProvinceOfIssue, QuickFix.Fields.Tags.LocaleOfIssue, QuickFix.Fields.Tags.RedemptionDate, QuickFix.Fields.Tags.StrikePrice, QuickFix.Fields.Tags.StrikeCurrency, QuickFix.Fields.Tags.OptAttribute, QuickFix.Fields.Tags.ContractMultiplier, QuickFix.Fields.Tags.CouponRate, QuickFix.Fields.Tags.SecurityExchange, QuickFix.Fields.Tags.Issuer, QuickFix.Fields.Tags.EncodedIssuerLen, QuickFix.Fields.Tags.EncodedIssuer, QuickFix.Fields.Tags.SecurityDesc, QuickFix.Fields.Tags.EncodedSecurityDescLen, QuickFix.Fields.Tags.EncodedSecurityDesc, QuickFix.Fields.Tags.Pool, QuickFix.Fields.Tags.ContractSettlMonth, QuickFix.Fields.Tags.CPProgram, QuickFix.Fields.Tags.CPRegType, QuickFix.Fields.Tags.NoEvents, QuickFix.Fields.Tags.DatedDate, QuickFix.Fields.Tags.InterestAccrualDate, QuickFix.Fields.Tags.SecurityStat, QuickFix.Fields.Tags.SettleOnOpenFlag, QuickFix.Fields.Tags.InstrmtAssignmentMethod, QuickFix.Fields.Tags.StrikeMultiplier, QuickFix.Fields.Tags.StrikeValue, QuickFix.Fields.Tags.MinPriceIncrement, QuickFix.Fields.Tags.PositionLimit, QuickFix.Fields.Tags.NTPositionLimit, QuickFix.Fields.Tags.NoInstrumentParties, QuickFix.Fields.Tags.UnitOfMeasure, QuickFix.Fields.Tags.TimeUnit, QuickFix.Fields.Tags.MaturityTime, QuickFix.Fields.Tags.NoUnderlyings, QuickFix.Fields.Tags.PrevClosePx, QuickFix.Fields.Tags.Side, QuickFix.Fields.Tags.SideValueInd, QuickFix.Fields.Tags.LocateReqd, QuickFix.Fields.Tags.TransactTime, QuickFix.Fields.Tags.NoStipulations, QuickFix.Fields.Tags.QtyType, QuickFix.Fields.Tags.OrderQty, QuickFix.Fields.Tags.CashOrderQty, QuickFix.Fields.Tags.OrderPercent, QuickFix.Fields.Tags.RoundingDirection, QuickFix.Fields.Tags.RoundingModulus, QuickFix.Fields.Tags.OrdType, QuickFix.Fields.Tags.PriceType, QuickFix.Fields.Tags.Price, QuickFix.Fields.Tags.StopPx, QuickFix.Fields.Tags.Spread, QuickFix.Fields.Tags.BenchmarkCurveCurrency, QuickFix.Fields.Tags.BenchmarkCurveName, QuickFix.Fields.Tags.BenchmarkCurvePoint, QuickFix.Fields.Tags.BenchmarkPrice, QuickFix.Fields.Tags.BenchmarkPriceType, QuickFix.Fields.Tags.BenchmarkSecurityID, QuickFix.Fields.Tags.BenchmarkSecurityIDSource, QuickFix.Fields.Tags.YieldType, QuickFix.Fields.Tags.Yield, QuickFix.Fields.Tags.YieldCalcDate, QuickFix.Fields.Tags.YieldRedemptionDate, QuickFix.Fields.Tags.YieldRedemptionPrice, QuickFix.Fields.Tags.YieldRedemptionPriceType, QuickFix.Fields.Tags.Currency, QuickFix.Fields.Tags.ComplianceID, QuickFix.Fields.Tags.SolicitedFlag, QuickFix.Fields.Tags.IOIID, QuickFix.Fields.Tags.QuoteID, QuickFix.Fields.Tags.TimeInForce, QuickFix.Fields.Tags.EffectiveTime, QuickFix.Fields.Tags.ExpireDate, QuickFix.Fields.Tags.ExpireTime, QuickFix.Fields.Tags.GTBookingInst, QuickFix.Fields.Tags.Commission, QuickFix.Fields.Tags.CommType, QuickFix.Fields.Tags.CommCurrency, QuickFix.Fields.Tags.FundRenewWaiv, QuickFix.Fields.Tags.OrderCapacity, QuickFix.Fields.Tags.OrderRestrictions, QuickFix.Fields.Tags.CustOrderCapacity, QuickFix.Fields.Tags.ForexReq, QuickFix.Fields.Tags.SettlCurrency, QuickFix.Fields.Tags.BookingType, QuickFix.Fields.Tags.Text, QuickFix.Fields.Tags.EncodedTextLen, QuickFix.Fields.Tags.EncodedText, QuickFix.Fields.Tags.SettlDate2, QuickFix.Fields.Tags.OrderQty2, QuickFix.Fields.Tags.Price2, QuickFix.Fields.Tags.PositionEffect, QuickFix.Fields.Tags.CoveredOrUncovered, QuickFix.Fields.Tags.MaxShow, QuickFix.Fields.Tags.PegOffsetValue, QuickFix.Fields.Tags.PegMoveType, QuickFix.Fields.Tags.PegOffsetType, QuickFix.Fields.Tags.PegLimitType, QuickFix.Fields.Tags.PegRoundDirection, QuickFix.Fields.Tags.PegScope, QuickFix.Fields.Tags.PegPriceType, QuickFix.Fields.Tags.PegSecurityIDSource, QuickFix.Fields.Tags.PegSecurityID, QuickFix.Fields.Tags.PegSymbol, QuickFix.Fields.Tags.PegSecurityDesc, QuickFix.Fields.Tags.DiscretionInst, QuickFix.Fields.Tags.DiscretionOffsetValue, QuickFix.Fields.Tags.DiscretionMoveType, QuickFix.Fields.Tags.DiscretionOffsetType, QuickFix.Fields.Tags.DiscretionLimitType, QuickFix.Fields.Tags.DiscretionRoundDirection, QuickFix.Fields.Tags.DiscretionScope, QuickFix.Fields.Tags.TargetStrategy, QuickFix.Fields.Tags.TargetStrategyParameters, QuickFix.Fields.Tags.ParticipationRate, QuickFix.Fields.Tags.Designation, QuickFix.Fields.Tags.NoStrategyParameters, QuickFix.Fields.Tags.MatchIncrement, QuickFix.Fields.Tags.MaxPriceLevels, QuickFix.Fields.Tags.SecondaryDisplayQty, QuickFix.Fields.Tags.DisplayWhen, QuickFix.Fields.Tags.DisplayMethod, QuickFix.Fields.Tags.DisplayLowQty, QuickFix.Fields.Tags.DisplayHighQty, QuickFix.Fields.Tags.DisplayMinIncr, QuickFix.Fields.Tags.RefreshQty, QuickFix.Fields.Tags.DisplayQty, QuickFix.Fields.Tags.PriceProtectionScope, QuickFix.Fields.Tags.TriggerType, QuickFix.Fields.Tags.TriggerAction, QuickFix.Fields.Tags.TriggerPrice, QuickFix.Fields.Tags.TriggerSymbol, QuickFix.Fields.Tags.TriggerSecurityID, QuickFix.Fields.Tags.TriggerSecurityIDSource, QuickFix.Fields.Tags.TriggerSecurityDesc, QuickFix.Fields.Tags.TriggerPriceType, QuickFix.Fields.Tags.TriggerPriceTypeScope, QuickFix.Fields.Tags.TriggerPriceDirection, QuickFix.Fields.Tags.TriggerNewPrice, QuickFix.Fields.Tags.TriggerOrderType, QuickFix.Fields.Tags.TriggerNewQty, QuickFix.Fields.Tags.TriggerTradingSessionID, QuickFix.Fields.Tags.TriggerTradingSessionSubID, QuickFix.Fields.Tags.RefOrderID, QuickFix.Fields.Tags.RefOrderIDSource, QuickFix.Fields.Tags.PreTradeAnonymity, QuickFix.Fields.Tags.ExDestinationIDSource, 0};
                ...
                { 
                    return IsSetField(QuickFix.Fields.Tags.ExDestinationIDSource);
                }
