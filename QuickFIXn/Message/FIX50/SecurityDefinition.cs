...
namespace QuickFix.FIX50
{
    public class SecurityDefinition : Message
    {
            ...
            public class ClearingBusinessDateGroup : Group
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.LegOptionRatio, QuickFix.Fields.Tags.LegPrice, 0};
            
                public ClearingBusinessDateGroup() 
                  :base( QuickFix.Fields.Tags.ClearingBusinessDate, QuickFix.Fields.Tags.LegOptionRatio, fieldOrder)
                {
                }
            
                public override Group Clone()
                {
                    var clone = new ClearingBusinessDateGroup();
                    clone.CopyStateFrom(this);
                    return clone;
                }
