...
namespace QuickFix.FIX50
{
    public class MultilegOrderCancelReplace : Message
    {
            ...
            public class NoLegsGroup : Group
            {
                ...
                {
                    public static int[] fieldOrder = {QuickFix.Fields.Tags.LegAllocAccount, QuickFix.Fields.Tags.LegIndividualAllocID, QuickFix.Fields.Tags.NoNested2PartyIDs, QuickFix.Fields.Tags.LegAllocQty, QuickFix.Fields.Tags.LegAllocAcctIDSource, QuickFix.Fields.Tags.LegSettlCurrency, 0};
