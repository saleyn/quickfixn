...
namespace QuickFix.FIX50
{
    public class ContraryIntentionReport : Message
    {
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.ContIntRptID);
            }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.LateIndicator);
            }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.InputSource);
            }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.NoExpiration);
            }
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.ExpType, QuickFix.Fields.Tags.ExpQty, 0};
            
                public NoExpirationGroup() 
                  :base( QuickFix.Fields.Tags.NoExpiration, QuickFix.Fields.Tags.ExpType, fieldOrder)
                {
                }
                ...
                public void Set(QuickFix.Fields.ExpType val) 
                { 
                    ExpType = val;
                }
                ...
                public bool IsSet(QuickFix.Fields.ExpType val) 
                { 
                    return IsSetExpType();
                }
                
                public bool IsSetExpType() 
                { 
                    return IsSetField(QuickFix.Fields.Tags.ExpType);
                }
                ...
                { 
                    return IsSetField(QuickFix.Fields.Tags.ExpQty);
                }
