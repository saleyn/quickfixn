...
namespace QuickFix.FIX42
{
    public class BidRequest : Message
    {
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.ListID, QuickFix.Fields.Tags.Side, QuickFix.Fields.Tags.TradingSessionID, QuickFix.Fields.Tags.NetGrossInd, QuickFix.Fields.Tags.SettlmntTyp, QuickFix.Fields.Tags.FutSettDate, QuickFix.Fields.Tags.Account, 0};
