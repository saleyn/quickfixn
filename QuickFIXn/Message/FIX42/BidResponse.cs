...
namespace QuickFix.FIX42
{
    public class BidResponse : Message
    {
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.Commission, QuickFix.Fields.Tags.CommType, QuickFix.Fields.Tags.ListID, QuickFix.Fields.Tags.Country, QuickFix.Fields.Tags.Side, QuickFix.Fields.Tags.Price, QuickFix.Fields.Tags.PriceType, QuickFix.Fields.Tags.FairValue, QuickFix.Fields.Tags.NetGrossInd, QuickFix.Fields.Tags.SettlmntTyp, QuickFix.Fields.Tags.FutSettDate, QuickFix.Fields.Tags.TradingSessionID, QuickFix.Fields.Tags.Text, QuickFix.Fields.Tags.EncodedTextLen, QuickFix.Fields.Tags.EncodedText, 0};
