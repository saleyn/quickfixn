...
namespace QuickFix.FIX44
{
    public class MarketDataRequest : Message
    {
            ...
            { 
                get 
                {
                    var val = new QuickFix.Fields.ApplQueueAction();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.ApplQueueAction);
            }
            ...
            { 
                get 
                {
                    var val = new QuickFix.Fields.ApplQueueMax();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.ApplQueueMax);
            }
