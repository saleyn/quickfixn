...
namespace QuickFix.FIX50SP1
{
    public class ExecutionReport : Message
    {
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.FillExecID, QuickFix.Fields.Tags.FillPx, QuickFix.Fields.Tags.FillQty, QuickFix.Fields.Tags.NoNested4PartyIDs, 0};
