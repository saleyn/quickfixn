    ...
    public class MarketDataIncrementalRefresh : Message
    {
            ...
            public class NoMDEntriesGroup : Group
            {
                ...
                { 
                    get 
                    {
                        var val = new QuickFix.Fields.HaltReasonChar();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    return IsSetField(QuickFix.Fields.Tags.HaltReasonChar);
                }
