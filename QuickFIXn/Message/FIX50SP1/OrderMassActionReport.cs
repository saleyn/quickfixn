...
namespace QuickFix.FIX50SP1
{
    public class OrderMassActionReport : Message
    {
            ...
            { 
                get 
                {
                    var val = new QuickFix.Fields.MassActionType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.MassActionType);
            }
            ...
            { 
                get 
                {
                    var val = new QuickFix.Fields.MassActionScope();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.MassActionScope);
            }
            ...
            { 
                get 
                {
                    var val = new QuickFix.Fields.MassActionResponse();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.MassActionResponse);
            }
            ...
            { 
                get 
                {
                    var val = new QuickFix.Fields.MassActionRejectReason();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.MassActionRejectReason);
            }
