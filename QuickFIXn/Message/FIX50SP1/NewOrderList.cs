...
namespace QuickFix.FIX50SP1
{
    public class NewOrderList : Message
    {
            ...
            { 
                get 
                {
                    var val = new QuickFix.Fields.ContingencyType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
