...
namespace QuickFix.FIX50SP1
{
    public class CrossOrderCancelReplaceRequest : Message
    {
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.CrossPrioritization);
            }
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.Side, QuickFix.Fields.Tags.ClOrdID, QuickFix.Fields.Tags.SecondaryClOrdID, QuickFix.Fields.Tags.ClOrdLinkID, QuickFix.Fields.Tags.NoPartyIDs, QuickFix.Fields.Tags.TradeOriginationDate, QuickFix.Fields.Tags.TradeDate, QuickFix.Fields.Tags.Account, QuickFix.Fields.Tags.AcctIDSource, QuickFix.Fields.Tags.AccountType, QuickFix.Fields.Tags.DayBookingInst, QuickFix.Fields.Tags.BookingUnit, QuickFix.Fields.Tags.PreallocMethod, QuickFix.Fields.Tags.AllocID, QuickFix.Fields.Tags.NoAllocs, QuickFix.Fields.Tags.QtyType, QuickFix.Fields.Tags.OrderQty, QuickFix.Fields.Tags.CashOrderQty, QuickFix.Fields.Tags.OrderPercent, QuickFix.Fields.Tags.RoundingDirection, QuickFix.Fields.Tags.RoundingModulus, QuickFix.Fields.Tags.Commission, QuickFix.Fields.Tags.CommType, QuickFix.Fields.Tags.CommCurrency, QuickFix.Fields.Tags.FundRenewWaiv, QuickFix.Fields.Tags.OrderCapacity, QuickFix.Fields.Tags.OrderRestrictions, QuickFix.Fields.Tags.CustOrderCapacity, QuickFix.Fields.Tags.ForexReq, QuickFix.Fields.Tags.SettlCurrency, QuickFix.Fields.Tags.BookingType, QuickFix.Fields.Tags.Text, QuickFix.Fields.Tags.EncodedTextLen, QuickFix.Fields.Tags.EncodedText, QuickFix.Fields.Tags.PositionEffect, QuickFix.Fields.Tags.CoveredOrUncovered, QuickFix.Fields.Tags.CashMargin, QuickFix.Fields.Tags.ClearingFeeIndicator, QuickFix.Fields.Tags.SolicitedFlag, QuickFix.Fields.Tags.SideComplianceID, QuickFix.Fields.Tags.SideTimeInForce, QuickFix.Fields.Tags.PreTradeAnonymity, QuickFix.Fields.Tags.OrigClOrdID, 0};
                ...
                { 
                    return IsSetField(QuickFix.Fields.Tags.SideComplianceID);
                }
                ...
                { 
                    get 
                    {
                        var val = new QuickFix.Fields.SideTimeInForce();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    return IsSetField(QuickFix.Fields.Tags.SideTimeInForce);
                }
