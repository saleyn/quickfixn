    ...
    public class IOI : Message
    {
            ...
            public class NoLegsGroup : Group
            {
                ...
                { 
                    get 
                    {
                        var val = new QuickFix.Fields.LegIOIQty();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    return IsSetField(QuickFix.Fields.Tags.LegIOIQty);
                }
