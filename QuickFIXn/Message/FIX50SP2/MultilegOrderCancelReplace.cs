...
namespace QuickFix.FIX50SP2
{
    public class MultilegOrderCancelReplace : Message
    {
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.MultiLegRptTypeReq);
            }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.SwapPoints);
            }
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.AllocAccount, QuickFix.Fields.Tags.AllocAcctIDSource, QuickFix.Fields.Tags.AllocSettlCurrency, QuickFix.Fields.Tags.IndividualAllocID, QuickFix.Fields.Tags.NoNested3PartyIDs, QuickFix.Fields.Tags.AllocQty, 0};
