...
namespace QuickFix.FIX50SP2
{
    public class ListStatus : Message
    {
            ...
            { 
                get 
                {
                    var val = new QuickFix.Fields.ListRejectReason();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.ListRejectReason);
            }
            
            public class NoOrdersGroup : Group
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.ClOrdID, QuickFix.Fields.Tags.SecondaryClOrdID, QuickFix.Fields.Tags.CumQty, QuickFix.Fields.Tags.OrdStatus, QuickFix.Fields.Tags.WorkingIndicator, QuickFix.Fields.Tags.LeavesQty, QuickFix.Fields.Tags.CxlQty, QuickFix.Fields.Tags.AvgPx, QuickFix.Fields.Tags.OrdRejReason, QuickFix.Fields.Tags.Text, QuickFix.Fields.Tags.EncodedTextLen, QuickFix.Fields.Tags.EncodedText, QuickFix.Fields.Tags.OrderID, 0};
