...
namespace QuickFix.FIX50SP2
{
    public class TradeCaptureReport : Message
    {
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.TZTransactTime);
            }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.ReportedPxDiff);
            }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.RejectText);
            }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.CurrencyRatio);
            }
            ...
            public class NoSidesGroup : Group
            {
                ...
                { 
                    ExchangeSpecialInstructions = val;
                }
                ...
                { 
                    return IsSetField(QuickFix.Fields.Tags.ExchangeSpecialInstructions);
                }
                ...
                { 
                    return IsSetField(QuickFix.Fields.Tags.SideLiquidityInd);
                }
