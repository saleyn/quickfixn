...
namespace QuickFix.FIX50SP2
{
    public class ContraryIntentionReport : Message
    {
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.ExpirationQtyType, QuickFix.Fields.Tags.ExpQty, 0};
            
                public NoExpirationGroup() 
                  :base( QuickFix.Fields.Tags.NoExpiration, QuickFix.Fields.Tags.ExpirationQtyType, fieldOrder)
                {
                }
                ...
                { 
                    get 
                    {
                        var val = new QuickFix.Fields.ExpirationQtyType();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    return IsSetField(QuickFix.Fields.Tags.ExpirationQtyType);
                }
