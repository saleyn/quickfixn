...
namespace QuickFix.FIX50SP2
{
    public class SecurityTypes : Message
    {
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.SecurityType, QuickFix.Fields.Tags.SecuritySubType, QuickFix.Fields.Tags.Product, QuickFix.Fields.Tags.CFICode, QuickFix.Fields.Tags.TransactTime, 0};
