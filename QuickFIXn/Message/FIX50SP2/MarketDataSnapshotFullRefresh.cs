...
namespace QuickFix.FIX50SP2
{
    public class MarketDataSnapshotFullRefresh : Message
    {
            ...
            { 
                get 
                {
                    var val = new QuickFix.Fields.RefreshIndicator();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.RefreshIndicator);
            }
