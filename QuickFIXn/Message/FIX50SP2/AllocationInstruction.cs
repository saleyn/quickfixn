...
namespace QuickFix.FIX50SP2
{
    public class AllocationInstruction : Message
    {
            ...
            {
                public static int[] fieldOrder = {QuickFix.Fields.Tags.LastQty, QuickFix.Fields.Tags.ExecID, QuickFix.Fields.Tags.SecondaryExecID, QuickFix.Fields.Tags.LastPx, QuickFix.Fields.Tags.LastParPx, QuickFix.Fields.Tags.LastCapacity, QuickFix.Fields.Tags.TradeID, QuickFix.Fields.Tags.FirmTradeID, 0};
