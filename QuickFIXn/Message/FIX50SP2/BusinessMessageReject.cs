...
namespace QuickFix.FIX50SP2
{
    public class BusinessMessageReject : Message
    {
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.RefApplVerID);
            }
            ...
            { 
                get 
                {
                    var val = new QuickFix.Fields.RefApplExtID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.RefApplExtID);
            }
            ...
            { 
                return IsSetField(QuickFix.Fields.Tags.RefCstmApplVerID);
            }
