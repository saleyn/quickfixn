...
namespace QuickFix.FXCM
{
    public class MarketDataRequestReject : Message
    {
            ...
            public QuickFix.FXCM.Fields.MDReqRejReason MDReqRejReason
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.MDReqRejReason();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.MDReqRejReason val) 
            { 
                MDReqRejReason = val;
            }
            
            public QuickFix.FXCM.Fields.MDReqRejReason Get(QuickFix.FXCM.Fields.MDReqRejReason val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.MDReqRejReason val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.MDReqRejReason);
            }
            
            public QuickFix.FXCM.Fields.NoAltMDSource NoAltMDSource
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.NoAltMDSource();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.NoAltMDSource val) 
            { 
                NoAltMDSource = val;
            }
            
            public QuickFix.FXCM.Fields.NoAltMDSource Get(QuickFix.FXCM.Fields.NoAltMDSource val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.NoAltMDSource val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.NoAltMDSource);
            }
            ...
            {
                public static int[] fieldOrder = {QuickFix.FXCM.Fields.Tags.AltMDSourceID, 0};
            
                public NoAltMDSourceGroup() 
                  :base( QuickFix.FXCM.Fields.Tags.NoAltMDSource, QuickFix.FXCM.Fields.Tags.AltMDSourceID, fieldOrder)
                {
                }
                ...
                public override Group Clone()
                {
                    ...
                    return clone;
                            ...
                            public QuickFix.FXCM.Fields.AltMDSourceID AltMDSourceID
                { 
                    get 
                    {
                        var val = new QuickFix.FXCM.Fields.AltMDSourceID();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.FXCM.Fields.AltMDSourceID val) 
                { 
                    AltMDSourceID = val;
                }
                
                public QuickFix.FXCM.Fields.AltMDSourceID Get(QuickFix.FXCM.Fields.AltMDSourceID val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.FXCM.Fields.AltMDSourceID val) 
                { 
                ...
                { 
                    return IsSetField(QuickFix.FXCM.Fields.Tags.AltMDSourceID);
                }
