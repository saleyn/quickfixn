...
namespace QuickFix.FXCM
{
    public class OrderMassStatusRequest : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AF"));
            }

            public OrderMassStatusRequest(
                    QuickFix.FXCM.Fields.MassStatusReqID aMassStatusReqID,
                    QuickFix.FXCM.Fields.MassStatusReqType aMassStatusReqType
                ) : this()
            {
            ...
            public QuickFix.FXCM.Fields.MassStatusReqType MassStatusReqType
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.MassStatusReqType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.MassStatusReqType val) 
            { 
                MassStatusReqType = val;
            }
            
            public QuickFix.FXCM.Fields.MassStatusReqType Get(QuickFix.FXCM.Fields.MassStatusReqType val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.MassStatusReqType val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.MassStatusReqType);
            }
