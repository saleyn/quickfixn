...
namespace QuickFix.FXCM
{
    public class AllocationInstruction : Message
    {
            ...
            public AllocationInstruction(
                    ...
                    QuickFix.FXCM.Fields.AllocType aAllocType,
