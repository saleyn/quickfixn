...
namespace QuickFix.FXCM
{
    public class SecurityDefinition : Message
    {
            ...
            public QuickFix.FXCM.Fields.RoundLot RoundLot
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.RoundLot();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.RoundLot val) 
            { 
                RoundLot = val;
            }
            
            public QuickFix.FXCM.Fields.RoundLot Get(QuickFix.FXCM.Fields.RoundLot val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.RoundLot val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.RoundLot);
            }
