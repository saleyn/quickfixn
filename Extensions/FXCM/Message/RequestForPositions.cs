...
namespace QuickFix.FXCM
{
    public class RequestForPositions : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AN"));
            }

            public RequestForPositions(
                    QuickFix.FXCM.Fields.PosReqID aPosReqID,
                    QuickFix.FXCM.Fields.PosReqType aPosReqType,
            ...
            public QuickFix.FXCM.Fields.FXCMMaxNoResults FXCMMaxNoResults
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.FXCMMaxNoResults();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.FXCMMaxNoResults val) 
            { 
                FXCMMaxNoResults = val;
            }
            
            public QuickFix.FXCM.Fields.FXCMMaxNoResults Get(QuickFix.FXCM.Fields.FXCMMaxNoResults val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.FXCMMaxNoResults val) 
            { 
                return IsSetFXCMMaxNoResults();
            }
            
            public bool IsSetFXCMMaxNoResults() 
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.FXCMMaxNoResults);
            }
