...
namespace QuickFix.FXCM
{
    public class CrossOrderCancelReplaceRequest : Message
    {
            ...
            public CrossOrderCancelReplaceRequest(
                    QuickFix.FXCM.Fields.CrossID aCrossID,
                    QuickFix.FXCM.Fields.OrigCrossID aOrigCrossID,
                    QuickFix.FXCM.Fields.CrossType aCrossType,
                    QuickFix.FXCM.Fields.CrossPrioritization aCrossPrioritization,
            ...
            public QuickFix.FXCM.Fields.CrossPrioritization CrossPrioritization
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.CrossPrioritization();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.CrossPrioritization val) 
            { 
                CrossPrioritization = val;
            }
            
            public QuickFix.FXCM.Fields.CrossPrioritization Get(QuickFix.FXCM.Fields.CrossPrioritization val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.CrossPrioritization val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.CrossPrioritization);
            }
            ...
            {
                public static int[] fieldOrder = {QuickFix.FXCM.Fields.Tags.Side, QuickFix.FXCM.Fields.Tags.OrigClOrdID, QuickFix.FXCM.Fields.Tags.ClOrdID, QuickFix.FXCM.Fields.Tags.SecondaryClOrdID, QuickFix.FXCM.Fields.Tags.ClOrdLinkID, QuickFix.FXCM.Fields.Tags.OrigOrdModTime, QuickFix.FXCM.Fields.Tags.NoPartyIDs, QuickFix.FXCM.Fields.Tags.TradeOriginationDate, QuickFix.FXCM.Fields.Tags.TradeDate, QuickFix.FXCM.Fields.Tags.Account, QuickFix.FXCM.Fields.Tags.AcctIDSource, QuickFix.FXCM.Fields.Tags.AccountType, QuickFix.FXCM.Fields.Tags.DayBookingInst, QuickFix.FXCM.Fields.Tags.BookingUnit, QuickFix.FXCM.Fields.Tags.PreallocMethod, QuickFix.FXCM.Fields.Tags.AllocID, QuickFix.FXCM.Fields.Tags.NoAllocs, QuickFix.FXCM.Fields.Tags.QtyType, QuickFix.FXCM.Fields.Tags.OrderQty, QuickFix.FXCM.Fields.Tags.CashOrderQty, QuickFix.FXCM.Fields.Tags.OrderPercent, QuickFix.FXCM.Fields.Tags.RoundingDirection, QuickFix.FXCM.Fields.Tags.RoundingModulus, QuickFix.FXCM.Fields.Tags.Commission, QuickFix.FXCM.Fields.Tags.CommType, QuickFix.FXCM.Fields.Tags.CommCurrency, QuickFix.FXCM.Fields.Tags.FundRenewWaiv, QuickFix.FXCM.Fields.Tags.OrderCapacity, QuickFix.FXCM.Fields.Tags.OrderRestrictions, QuickFix.FXCM.Fields.Tags.CustOrderCapacity, QuickFix.FXCM.Fields.Tags.ForexReq, QuickFix.FXCM.Fields.Tags.SettlCurrency, QuickFix.FXCM.Fields.Tags.BookingType, QuickFix.FXCM.Fields.Tags.Text, QuickFix.FXCM.Fields.Tags.EncodedTextLen, QuickFix.FXCM.Fields.Tags.EncodedText, QuickFix.FXCM.Fields.Tags.PositionEffect, QuickFix.FXCM.Fields.Tags.CoveredOrUncovered, QuickFix.FXCM.Fields.Tags.CashMargin, QuickFix.FXCM.Fields.Tags.ClearingFeeIndicator, QuickFix.FXCM.Fields.Tags.SolicitedFlag, QuickFix.FXCM.Fields.Tags.SideComplianceID, 0};
                ...
                public QuickFix.FXCM.Fields.SideComplianceID SideComplianceID
                { 
                    get 
                    {
                        var val = new QuickFix.FXCM.Fields.SideComplianceID();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.FXCM.Fields.SideComplianceID val) 
                { 
                    SideComplianceID = val;
                }
                
                public QuickFix.FXCM.Fields.SideComplianceID Get(QuickFix.FXCM.Fields.SideComplianceID val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.FXCM.Fields.SideComplianceID val) 
                { 
                ...
                { 
                    return IsSetField(QuickFix.FXCM.Fields.Tags.SideComplianceID);
                }
