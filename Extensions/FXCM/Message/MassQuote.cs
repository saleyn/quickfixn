...
namespace QuickFix.FXCM
{
    public class MassQuote : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("i"));
            }
            ...
            public QuickFix.FXCM.Fields.DefBidSize DefBidSize
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.DefBidSize();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.DefBidSize val) 
            { 
                DefBidSize = val;
            }
            
            public QuickFix.FXCM.Fields.DefBidSize Get(QuickFix.FXCM.Fields.DefBidSize val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.DefBidSize val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.DefBidSize);
            }
            
            public QuickFix.FXCM.Fields.DefOfferSize DefOfferSize
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.DefOfferSize();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.DefOfferSize val) 
            { 
                DefOfferSize = val;
            }
            
            public QuickFix.FXCM.Fields.DefOfferSize Get(QuickFix.FXCM.Fields.DefOfferSize val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.DefOfferSize val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.DefOfferSize);
            }
            ...
            public class NoQuoteSetsGroup : Group
            {
                ...
                public QuickFix.FXCM.Fields.QuoteSetValidUntilTime QuoteSetValidUntilTime
                { 
                    get 
                    {
                        var val = new QuickFix.FXCM.Fields.QuoteSetValidUntilTime();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.FXCM.Fields.QuoteSetValidUntilTime val) 
                { 
                    QuoteSetValidUntilTime = val;
                }
                
                public QuickFix.FXCM.Fields.QuoteSetValidUntilTime Get(QuickFix.FXCM.Fields.QuoteSetValidUntilTime val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.FXCM.Fields.QuoteSetValidUntilTime val) 
                { 
                ...
                { 
                    return IsSetField(QuickFix.FXCM.Fields.Tags.QuoteSetValidUntilTime);
                }
