...
namespace QuickFix.FXCM
{
    public class QuoteRequestReject : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AG"));
            }

            public QuoteRequestReject(
                    QuickFix.FXCM.Fields.QuoteReqID aQuoteReqID,
                    QuickFix.FXCM.Fields.QuoteRequestRejectReason aQuoteRequestRejectReason
                ) : this()
            {
            ...
            public QuickFix.FXCM.Fields.QuoteRequestRejectReason QuoteRequestRejectReason
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.QuoteRequestRejectReason();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.QuoteRequestRejectReason val) 
            { 
                QuoteRequestRejectReason = val;
            }
            
            public QuickFix.FXCM.Fields.QuoteRequestRejectReason Get(QuickFix.FXCM.Fields.QuoteRequestRejectReason val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.QuoteRequestRejectReason val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.QuoteRequestRejectReason);
            }
