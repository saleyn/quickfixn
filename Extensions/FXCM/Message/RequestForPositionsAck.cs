...
namespace QuickFix.FXCM
{
    public class RequestForPositionsAck : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AO"));
            }
            ...
            public RequestForPositionsAck(
                    ...
                    QuickFix.FXCM.Fields.PosReqStatus aPosReqStatus,
            ...
            public QuickFix.FXCM.Fields.PosReqStatus PosReqStatus
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.PosReqStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.PosReqStatus val) 
            { 
                PosReqStatus = val;
            }
            
            public QuickFix.FXCM.Fields.PosReqStatus Get(QuickFix.FXCM.Fields.PosReqStatus val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.PosReqStatus val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.PosReqStatus);
            }
