...
namespace QuickFix.FXCM
{
    public class MarketDataSnapshotFullRefresh : Message
    {
            ...
            public QuickFix.FXCM.Fields.FXCMTimingInterval FXCMTimingInterval
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.FXCMTimingInterval();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.FXCMTimingInterval val) 
            { 
                FXCMTimingInterval = val;
            }
            
            public QuickFix.FXCM.Fields.FXCMTimingInterval Get(QuickFix.FXCM.Fields.FXCMTimingInterval val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.FXCMTimingInterval val) 
            { 
                return IsSetFXCMTimingInterval();
            }
            
            public bool IsSetFXCMTimingInterval() 
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.FXCMTimingInterval);
            }
            
            public QuickFix.FXCM.Fields.FXCMContinuousFlag FXCMContinuousFlag
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.FXCMContinuousFlag();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.FXCMContinuousFlag val) 
            { 
                FXCMContinuousFlag = val;
            }
            
            public QuickFix.FXCM.Fields.FXCMContinuousFlag Get(QuickFix.FXCM.Fields.FXCMContinuousFlag val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.FXCMContinuousFlag val) 
            { 
                return IsSetFXCMContinuousFlag();
            }
            
            public bool IsSetFXCMContinuousFlag() 
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.FXCMContinuousFlag);
            }
