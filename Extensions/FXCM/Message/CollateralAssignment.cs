...
namespace QuickFix.FXCM
{
    public class CollateralAssignment : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AY"));
            }
            ...
            public CollateralAssignment(
                    ...
                    QuickFix.FXCM.Fields.CollAsgnTransType aCollAsgnTransType,
            ...
            public QuickFix.FXCM.Fields.CollAsgnRefID CollAsgnRefID
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.CollAsgnRefID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.CollAsgnRefID val) 
            { 
                CollAsgnRefID = val;
            }
            
            public QuickFix.FXCM.Fields.CollAsgnRefID Get(QuickFix.FXCM.Fields.CollAsgnRefID val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.CollAsgnRefID val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.CollAsgnRefID);
            }
