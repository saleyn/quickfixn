...
namespace QuickFix.FXCM
{
    public class TradeCaptureReportRequestAck : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AQ"));
            }

            public TradeCaptureReportRequestAck(
                    QuickFix.FXCM.Fields.TradeRequestID aTradeRequestID,
                    QuickFix.FXCM.Fields.TradeRequestType aTradeRequestType,
                    QuickFix.FXCM.Fields.TradeRequestResult aTradeRequestResult,
                    QuickFix.FXCM.Fields.TradeRequestStatus aTradeRequestStatus
                ) : this()
            {
            ...
            public QuickFix.FXCM.Fields.TradeRequestType TradeRequestType
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.TradeRequestType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.TradeRequestType val) 
            { 
                TradeRequestType = val;
            }
            
            public QuickFix.FXCM.Fields.TradeRequestType Get(QuickFix.FXCM.Fields.TradeRequestType val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.TradeRequestType val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.TradeRequestType);
            }
            ...
            public QuickFix.FXCM.Fields.TradeRequestResult TradeRequestResult
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.TradeRequestResult();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.TradeRequestResult val) 
            { 
                TradeRequestResult = val;
            }
            
            public QuickFix.FXCM.Fields.TradeRequestResult Get(QuickFix.FXCM.Fields.TradeRequestResult val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.TradeRequestResult val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.TradeRequestResult);
            }
            
            public QuickFix.FXCM.Fields.TradeRequestStatus TradeRequestStatus
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.TradeRequestStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.TradeRequestStatus val) 
            { 
                TradeRequestStatus = val;
            }
            
            public QuickFix.FXCM.Fields.TradeRequestStatus Get(QuickFix.FXCM.Fields.TradeRequestStatus val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.TradeRequestStatus val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.TradeRequestStatus);
            }
