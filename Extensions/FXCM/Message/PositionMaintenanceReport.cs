...
namespace QuickFix.FXCM
{
    public class PositionMaintenanceReport : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("AM"));
            }
            ...
            public PositionMaintenanceReport(
                    ...
                    QuickFix.FXCM.Fields.OrigPosReqRefID aOrigPosReqRefID,
                    QuickFix.FXCM.Fields.PosMaintStatus aPosMaintStatus,
            ...
            public QuickFix.FXCM.Fields.PosMaintStatus PosMaintStatus
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.PosMaintStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.PosMaintStatus val) 
            { 
                PosMaintStatus = val;
            }
            
            public QuickFix.FXCM.Fields.PosMaintStatus Get(QuickFix.FXCM.Fields.PosMaintStatus val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.PosMaintStatus val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.PosMaintStatus);
            }
            
            public QuickFix.FXCM.Fields.PosMaintResult PosMaintResult
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.PosMaintResult();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.PosMaintResult val) 
            { 
                PosMaintResult = val;
            }
            
            public QuickFix.FXCM.Fields.PosMaintResult Get(QuickFix.FXCM.Fields.PosMaintResult val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.PosMaintResult val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.PosMaintResult);
            }
