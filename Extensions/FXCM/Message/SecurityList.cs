...
namespace QuickFix.FXCM
{
    public class SecurityList : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("y"));
            }

            public SecurityList(
                    QuickFix.FXCM.Fields.SecurityReqID aSecurityReqID,
                    QuickFix.FXCM.Fields.SecurityResponseID aSecurityResponseID,
                    QuickFix.FXCM.Fields.SecurityRequestResult aSecurityRequestResult
                ) : this()
            {
            ...
            public QuickFix.FXCM.Fields.SecurityRequestResult SecurityRequestResult
            { 
                get 
                {
                    var val = new QuickFix.FXCM.Fields.SecurityRequestResult();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.FXCM.Fields.SecurityRequestResult val) 
            { 
                SecurityRequestResult = val;
            }
            
            public QuickFix.FXCM.Fields.SecurityRequestResult Get(QuickFix.FXCM.Fields.SecurityRequestResult val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.FXCM.Fields.SecurityRequestResult val) 
            { 
            ...
            { 
                return IsSetField(QuickFix.FXCM.Fields.Tags.SecurityRequestResult);
            }
            ...
            public class NoRelatedSymGroup : Group
            {
                ...
                public QuickFix.FXCM.Fields.RoundLotQty RoundLotQty
                { 
                    get 
                    {
                        var val = new QuickFix.FXCM.Fields.RoundLotQty();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.FXCM.Fields.RoundLotQty val) 
                { 
                    RoundLotQty = val;
                }
                
                public QuickFix.FXCM.Fields.RoundLotQty Get(QuickFix.FXCM.Fields.RoundLotQty val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.FXCM.Fields.RoundLotQty val) 
                { 
                    return IsSetRoundLotQty();
                }
                
                public bool IsSetRoundLotQty() 
                { 
                    return IsSetField(QuickFix.FXCM.Fields.Tags.RoundLotQty);
                }
                
                public QuickFix.FXCM.Fields.MinTradeVol MinTradeVol
                { 
                    get 
                    {
                        var val = new QuickFix.FXCM.Fields.MinTradeVol();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.FXCM.Fields.MinTradeVol val) 
                { 
                    MinTradeVol = val;
                }
                
                public QuickFix.FXCM.Fields.MinTradeVol Get(QuickFix.FXCM.Fields.MinTradeVol val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.FXCM.Fields.MinTradeVol val) 
                { 
                ...
                { 
                    return IsSetField(QuickFix.FXCM.Fields.Tags.MinTradeVol);
                }
