...
namespace QuickFix.FXCM
{
    public class CrossOrderCancelRequest : Message
    {
            ...
            {
                this.Header.SetField(new QuickFix.FXCM.Fields.MsgType("u"));
            }
